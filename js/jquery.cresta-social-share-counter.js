		...
		totalShares($URL);
			...
			function twitterShares($URL) {
				...
				if ( $('#twitter-cresta').hasClass('twitter-cresta-share') ) {
					...
					$.getJSON('//cdn.api.twitter.com/1/urls/count.json?url=' + $URL + '&callback=?', function (twitdata) {
			...
			function linkedInShares($URL) {
				...
				if ( $('#linkedin-cresta').hasClass('linkedin-cresta-share') ) {
					...
					$.getJSON('//www.linkedin.com/countserv/count/share?url=' + $URL + '&callback=?', function (linkedindata) {
