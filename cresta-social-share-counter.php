 ...
 * Description: Share your posts and pages quickly and easily with Cresta Social Share Count showing the share count.
 * Version: 1.0
...
function cresta_filter_in_content( $content ) { 
	...
	if( is_search() || is_404() || is_home() || is_archive() ) {
				return $content;
	}
		
	if($before_content == 1) {
		$add_social_button_in_content = add_social_button_in_content();
		$content = $add_social_button_in_content.$content;
	}
	if($after_content == 1) {
		$add_social_button_in_content = add_social_button_in_content();
		$content .= $add_social_button_in_content;
	}
...
function add_social_button_in_content() {
	...
	if(in_array('facebook',$buttons)) {
		$allButtonsSelected .= '<div class="sbutton facebook-cresta-share" id="facebook-cresta"><a rel="nofollow" href="http://www.facebook.com/sharer.php?u='. urlencode(get_permalink()) .'&t='. urlencode(get_the_title()) .'" title="Share to Facebook" onclick="window.open(this.href,\'targetWindow\',\'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=450\');return false;"><i class="fa fa-facebook"></i></a></div>';
	}

	if(in_array('tweet',$buttons)) {
		$allButtonsSelected .= '<div class="sbutton twitter-cresta-share" id="twitter-cresta"><a rel="nofollow" href="http://twitter.com/share?text='. urlencode(get_the_title()) .'&url='. urlencode(get_permalink()) .'" title="Share to Twitter" onclick="window.open(this.href,\'targetWindow\',\'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=450\');return false;"><i class="fa fa-twitter"></i></a></div>';
	}
	...
	if(in_array('linkedin',$buttons)) {
		$allButtonsSelected .= '<div class="sbutton linkedin-cresta-share" id="linkedin-cresta"><a rel="nofollow" href="http://www.linkedin.com/shareArticle?mini=true&url='. urlencode(get_permalink()) .'&title='. urlencode(get_the_title()) .'&source='. esc_url( home_url( '/' )) .'" title="Share to LinkedIn" onclick="window.open(this.href,\'targetWindow\',\'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=450\');return false;"><i class="fa fa-linkedin"></i></a></div>';
	}

	if(in_array('pinterest',$buttons)) {
		$allButtonsSelected .= '<div class="sbutton pinterest-cresta-share" id="pinterest-cresta"><a rel="nofollow" href="http://pinterest.com/pin/create/bookmarklet/?url='.urlencode(get_permalink()) .'&media='. $pinImage .'&description='. urlencode(get_the_title()) .'" title="Share to Pinterest" onclick="window.open(this.href,\'targetWindow\',\'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=450\');return false;"><i class="fa fa-pinterest"></i></a></div>';
	}
	
	return '<!--www.crestaproject.com Social Button in Content Start--><div id="crestashareiconincontent" class="cresta-share-icon">'. $allButtonsSelected .'<br/><div style="clear: both;"></div></div><!--www.crestaproject.com Social Button in Content End-->';
...
function add_social_button() {
	...
	if( is_home() && !in_array( 'home', $show_on ) ) {
				return;
	}
	if( is_page() && !in_array( 'pages', $show_on ) ) {
				return;
...
if(in_array('tweet',$buttons)) {
	echo '<div class="sbutton twitter-cresta-share" id="twitter-cresta"><a rel="nofollow" href="http://twitter.com/share?text='. urlencode(get_the_title()) .'&url='. urlencode(get_permalink()) .'" title="Share to Twitter" onclick="window.open(this.href,\'targetWindow\',\'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=450\');return false;"><i class="fa fa-twitter"></i></a>'; if($show_count == 1) { echo '<span class="cresta-the-count" id="twitter-count"></span>'; } echo '</div>';
}

if(in_array('gplus',$buttons)) {
	echo '<div class="sbutton googleplus-cresta-share" id="googleplus-cresta"><a rel="nofollow" href="https://plus.google.com/share?url='. urlencode(get_permalink()) .'" title="Share to Google Plus" onclick="window.open(this.href,\'targetWindow\',\'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=450\');return false;"><i class="fa fa-google-plus"></i></a>'; if($show_count == 1) { echo '<span class="cresta-the-count" id="googleplus-count"></span>'; } echo '</div>';
}

if(in_array('linkedin',$buttons)) {
	echo '<div class="sbutton linkedin-cresta-share" id="linkedin-cresta"><a rel="nofollow" href="http://www.linkedin.com/shareArticle?mini=true&url='. urlencode(get_permalink()) .'&title='. urlencode(get_the_title()) .'&source='. esc_url( home_url( '/' )) .'" title="Share to LinkedIn" onclick="window.open(this.href,\'targetWindow\',\'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=450\');return false;"><i class="fa fa-linkedin"></i></a>'; if($show_count == 1) { echo '<span class="cresta-the-count" id="linkedin-count"></span>'; } echo '</div>';
}

if(in_array('pinterest',$buttons)) {
	echo '<div class="sbutton pinterest-cresta-share" id="pinterest-cresta"><a rel="nofollow" href="http://pinterest.com/pin/create/bookmarklet/?url='.urlencode(get_permalink()) .'&media='. $pinImage .'&description='. urlencode(get_the_title()) .'" title="Share to Pinterest" onclick="window.open(this.href,\'targetWindow\',\'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700,height=450\');return false;"><i class="fa fa-pinterest"></i></a>'; if($show_count == 1) { echo '<span class="cresta-the-count" id="pinterest-count"></span>'; } echo '</div>';
}

if($show_count == 1) {
	echo '<div class="sbutton" id="total-shares"><span class="cresta-the-total-count" id="total-count"></span><span class="cresta-the-total-text">Shares</span></div>';
}
...
<div id="poststuff">
 ...
 <form name="social_buttons" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">  
		...
		<li class="list-group-item">
			<label><input type="checkbox" <?php if(in_array('tweet',$buttons)) { echo 'checked="checked"'; }?> name="socialbuttons[]" value="tweet"/>Twitter</label>
		</li>
		<li class="list-group-item">
		...
		<li class="list-group-item">
			<label><input type="checkbox" id="chksocialcounter" name="showthecounter"  <?php if(get_option('cresta_social_shares_show_counter') == "1") { echo 'checked="checked"'; }?> />Show Social Counter</label>
		</li>
		<li class="list-group-item">
		...
		<li class="list-group-item">
		Float Position : <label><input type="radio" name="floating" <?php if(get_option('cresta_social_shares_float') == "left") { echo 'checked="checked"'; }?> value="left" >Left</label> || <label><input type="radio" name="floating" value="right" <?php if(get_option('cresta_social_shares_float') == "right") { echo 'checked="checked"'; }?>>Right</label>
		</li>
		<li class="list-group-item">
		...
		<li class="list-group-item">
			<label><input type="checkbox" <?php if(in_array('home',$show_on)) { echo 'checked="checked"'; }?> name="socialpages[]" value="home"/>Home Page</label>
		</li>
		<li class="list-group-item">
		...
		<li class="list-group-item">
			<label><input type="checkbox" <?php if(in_array('archive',$show_on)) { echo 'checked="checked"'; }?> name="socialpages[]" value="posts"/>Archive</label>
		</li>
		</ul>
                        ...
                        <div class="postbox">
                            ...
                            <div class="inside">
								...
								<ul>
									...
									<li><div class="dashicons dashicons-yes crestaGreen"></div> 10 Exclusive Button Styles</li>
