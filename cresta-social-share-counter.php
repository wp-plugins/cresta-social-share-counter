...
<div id="poststuff">
 ...
 <form name="social_buttons" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">  
		...
		<li class="list-group-item">
			<label><input type="checkbox" id="chkanim" name="enabletheshadow" <?php if(get_option('cresta_social_shares_enable_shadow') == "1") { echo 'checked="checked"'; }?> /><?php _e('Enable shadow on buttons', 'crestassc'); ?></label>
		</li>
		<li class="list-group-item">
